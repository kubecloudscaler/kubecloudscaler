...
import (
	...
	"github.com/golgoth31/cloudscaler/internal/utils"
	k8sUtils "github.com/golgoth31/cloudscaler/pkg/k8s/utils"
	k8sClient "github.com/golgoth31/cloudscaler/pkg/k8s/utils/client"
	"github.com/golgoth31/cloudscaler/pkg/resources"
...
// +kubebuilder:rbac:groups=k8s.cloudscaler.io,resources=scalers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=k8s.cloudscaler.io,resources=scalers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=k8s.cloudscaler.io,resources=scalers/finalizers,verbs=update

...
type ResourceCreator interface {
	CreateK8sResource(ctx context.Context, flow *kubecloudscalerv1alpha3.Flow, resourceName string, k8sResource kubecloudscalerv1alpha3.K8sResource, periodsWithDelay []PeriodWithDelay) error
	CreateGcpResource(ctx context.Context, flow *kubecloudscalerv1alpha3.Flow, resourceName string, gcpResource kubecloudscalerv1alpha3.GcpResource, periodsWithDelay []PeriodWithDelay) error
}
...
// FlowReconcilerInterface defines the main interface for the FlowReconciler
type FlowReconcilerInterface interface {

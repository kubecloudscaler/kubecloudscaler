	...
	}{
		{
			...
			src: &v1alpha3.K8s{
				...
				Spec: v1alpha3.K8sSpec{
					...
					Resources: common.Resources{
						Types:         []common.ResourceKind{common.ResourceDeployments, common.ResourceCronJobs},
						Names:         []string{"my-cron"},
...
func TestK8sConversion_EmptyNilSlices(t *testing.T) {
	tests := []struct {
		...
		{
			name:      "nil types",
			resources: common.Resources{Types: nil},
		},
		{
			name:      "empty types",
			resources: common.Resources{Types: []common.ResourceKind{}},
		},
	}
